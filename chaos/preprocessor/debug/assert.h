...
# /* CHAOS_PP_ASSERT */
#
# define CHAOS_PP_ASSERT(cond) CHAOS_PP_INLINE_WHEN(CHAOS_PP_NOT(cond))(CHAOS_PP_FAILURE())
...
#
# if CHAOS_PP_VARIADICS
#    define CHAOS_PP_ASSERT_MSG(cond, ...) CHAOS_PP_INLINE_WHEN(CHAOS_PP_NOT(cond))(CHAOS_PP_FAILURE_MSG(__VA_ARGS__))
#    define CHAOS_PP_ASSERT_MSG_ CHAOS_PP_LAMBDA(CHAOS_PP_ASSERT_MSG)
# else
#    define CHAOS_PP_ASSERT_MSG(cond, msg) CHAOS_PP_INLINE_WHEN(CHAOS_PP_NOT(cond))(CHAOS_PP_FAILURE_MSG(msg))
# endif
#
